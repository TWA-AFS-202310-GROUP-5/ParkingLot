...
namespace ParkingLotManagementTest
{
    public class SmartParkingLotTest
    {
        ...
        public void Should_smart_parking_boy_park_car_to_more_empty_lot_given_two_available_lots(string carName)
        {
            ...
            for (var i = 0; i < 5; i++)
            {
                Ticket tempTicket = parkingLot1.Park(carName + "parkingLot1" + i);
            }

            for (var i = 0; i < 1; i++)
            {
                Ticket tempTicket = parkingLot2.Park(carName + "parkingLot2" + i);
            }
        ...
        public void Should_smart_parking_boy_park_car_to_second_given_first_full(string carName)
        {
            ...
            {
                Ticket tempTicket = parkingLot1.Park(carName + i);
            }
