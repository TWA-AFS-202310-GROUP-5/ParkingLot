...
namespace ParkingLotManagementTest
{
    public class ParkingLotManagementTest
    {
        ...
        [InlineData("Car")]
        [InlineData("Car2")]
        public void Should_smart_parking_boy_park_car_to_more_empty_lot_given_two_available_lots(string carName)
        {
            ParkingLot parkingLot1 = new ParkingLot("1");
            ParkingLot parkingLot2 = new ParkingLot("2");
            ...
            for (var i = 0; i < 5; i++)
            {
                Ticket teampTicket = parkingLot1.Park(carName + "parkingLot1" + i);
            }

            for (var i = 0; i < 1; i++)
            {
                Ticket teampTicket = parkingLot2.Park(carName + "parkingLot2" + i);
            }
        ...
        [Theory]
        [InlineData("Car")]
        public void Should_smart_parking_boy_park_car_to_second_given_first_full(string carName)
        {
            ParkingLot parkingLot1 = new ParkingLot("1");
            ParkingLot parkingLot2 = new ParkingLot("2");
            SmartParkingBoy parkingBoy = new SmartParkingBoy();
            ...
            for (var i = 0; i < parkingLot1.Capacity; i++)
            {
                Ticket teampTicket = parkingLot1.Park(carName + i);
            }
        ...
        [Theory]
        [InlineData("Car1", "Car2")]
        public void Should_smart_parking_boy_return_correct_car_given_two_car_in_two_parkinglots(string carName1, string carName2)
        {
            ParkingLot parkingLot1 = new ParkingLot("1");
            ParkingLot parkingLot2 = new ParkingLot("2");
            SmartParkingBoy parkingBoy = new SmartParkingBoy();
        ...
        [Theory]
        [InlineData("Car1")]
        public void Should_smart_parking_boy_return_empty_when_costumer_using_null_ticket(string carNameCorrect)
        {
            ParkingLot parkingLot1 = new ParkingLot("1");
            ParkingLot parkingLot2 = new ParkingLot("2");
            StandardParkingBoy parkingBoy = new StandardParkingBoy();
        ...
        [InlineData("Car")]
        [InlineData("Car2")]
        public void Should_smart_parking_boy_throw_exception_when_costumer_fetching_car_with_used_ticket(string carName)
        {
            ParkingLot parkingLot1 = new ParkingLot("1");
            ParkingLot parkingLot2 = new ParkingLot("2");
            SmartParkingBoy parkingBoy = new SmartParkingBoy();
        ...
        [Theory]
        [InlineData("Car", "Parking Lot AAA")]
        public void Should_smart_parking_boy_return_no_ticket_when_parking_lot_has_no_position_left(string carName, string parkingLotName)
        {
            ParkingLot parkingLot1 = new ParkingLot("1");
            ParkingLot parkingLot2 = new ParkingLot("2");
            SmartParkingBoy parkingBoy = new SmartParkingBoy();
